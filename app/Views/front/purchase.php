...
$total              = ($price* 100); // 100 = 1 indian rupees
$amount             = 1;
$merchant_order_id  = "ABC-".date("YmdHis");
$card_holder_name   = 'Saayan Biswas';
        ...
        <div class="page-body">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td><img class='w-9 h-8' src="uploads/<?php echo $products['image'];?>"></td>
                    <td class="text-right"></td>
</tr>
            </table>
            ₹ <?php echo $price;?>
            <div class="mt-2 text-right">
                <input  id="pay-btn" type="submit" onclick="razorpaySubmit(this);" value="Buy Now" class="bg-sky-600 text-white p-2 rounded-xl border-2" />
            </div>
        </div>
    </div>
